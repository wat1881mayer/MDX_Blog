...
<GatsbyImage image={getImage(props.embeddebImages[1])} alt="random stuff" className="first-inline-img" />
<GatsbyImage image={getImage(props.embeddebImages[2])} alt="random stuff" className="first-inline-img" />
